...
\begin{equation}
f_{\mathcal{G}}^{\text{EDUT}}(x,y)=\left\{
\begin{array}{cc}
 1 & \exists \mathit{p}\in \text{Permutations}(\mathcal{V}),\left\{
\begin{array}{c}
 \mathit{p}_i=x \\
 \mathit{p}_j=y \\
 i<j \\
 \prod _{k=i}^{j-1} f_{\mathcal{G}}^{\text{NDRT}}\left(\mathit{p}_k,p_{k+1}\right)=1 \\
\end{array}
\right. \\
 0 & \text{else} \\
\end{array}
